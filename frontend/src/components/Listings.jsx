...
export const Listings = () => {
  ...
  return <section id="rentals" className="texture-paper bg-linen py-24 sm:py-28" aria-busy={state === 'loading'}><div className="mx-auto max-w-7xl px-5 sm:px-8">
    ...
    <div className="grid gap-7 lg:grid-cols-2" data-testid="public-listing-grid">{visible.map((listing) => <article key={listing.listing_id} className="overflow-hidden border border-stone-200 bg-white" data-testid="public-listing-card">
