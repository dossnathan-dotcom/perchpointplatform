...
export const Footer = ({ onContact, onMaintenance }) => (
  <footer id="contact" className="bg-[#080B10] text-linen">
    <div className="mx-auto max-w-7xl px-5 py-16 sm:px-8">
      ...
      <div className="mt-14 grid gap-5 border-t border-white/20 pt-7 text-sm text-linen/75 md:grid-cols-[1fr_auto] md:items-center"><div><p>© 2026 HawkVision Homes · Initial region: Greater Cincinnati</p><DemoNotice id="footer-demo-disclosure" className="mt-2">Property information, addresses, entities, pricing and imagery are illustrative examples—not verified inventory.</DemoNotice>{PHASE0.seedsEnabled && <Link to="/foundation" className="mt-4 inline-block underline" data-testid="footer-foundation-link">Phase 0 foundation review</Link>}</div><div className="flex items-center gap-2" data-testid="footer-fair-housing"><ShieldCheck className="h-4 w-4 text-gold" /> Equal Housing Opportunity</div></div>
    </div>
  </footer>
);