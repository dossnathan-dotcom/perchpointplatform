...
| ID | Type | Decision/assumption | Owner | Blocking |
|---|---|---|---|---|
| OD-001 | unresolved | Exact HawkVision legal entity | Faruk | Contracts/production |
| OD-002 | unresolved | Exact Gorilla Technologies legal name | Nathan | IP agreement |
| OD-003 | unresolved | Formal accounting platform/specialist | Faruk | Financial activation |
| OD-004 | provisional | Ann emergency stabilization limit $2,500 | Faruk | Emergency activation |
| OD-005 | unresolved | Counsel-approved housing/legal policies | Faruk | Regulated workflows |
